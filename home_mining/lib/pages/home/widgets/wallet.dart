...
import 'package:home_mining/component/component.dart';
                        ...
                        SizedBox(
                          ...
                          child: Stack(children: [
                            ...
                            Positioned(
                              ...
                              child: Row(
                                children: [
                                  _dot(size: 27, color: Colors.orangeAccent),
                                  Text(
                                    '1BTC=\$5.483',
                                    style: TextStyle(
                                      fontWeight: FontWeight.bold,
  ...
  List<LineChartBarData> linesBarData() {
    return [
      LineChartBarData(
        ...
        belowBarData: BarAreaData(show: true, color: Colors.orange[100],),
      ),
    ];
  }
